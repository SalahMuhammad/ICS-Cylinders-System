package TransactionsBetween111;
...
public class DisplayDebtTransactionsBetween extends java.awt.Dialog
{

    public DisplayDebtTransactionsBetween(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
        
        mm.setTableRowsTextToCenter(debtTable, 3);
        ...
        mm.modificationJtablesHeader(debtTable);
    ...
    private void initComponents()
    {
        ...
        JScrollPane222222222.setViewportView(debtTable);
    ...
    {
        displayDebtTransactionsBetweenList = handler.displayDebtTransactionsBetween(from, to, "debt");

        model = (DefaultTableModel)debtTable.getModel();
        row = new Object[4];
        ...
        {
            total = total + (Integer)debtTable.getValueAt(i, 3);
        }
    ...
    public static void main(String args[])
    {
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                DisplayDebtTransactionsBetween dialog = new DisplayDebtTransactionsBetween(new java.awt.Frame(), true);
